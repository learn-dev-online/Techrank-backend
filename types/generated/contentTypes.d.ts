...
export interface ApiCourseListCourseList extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Type: Attribute.Enumeration<['Basic', 'Intermidiate', 'Advanced']> &
      Attribute.Required;
    Discription: Attribute.RichText;
    image: Attribute.Media;
    Topics: Attribute.Component<'topics.content', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiLogoSliderLogoSlider extends Schema.CollectionType {
  collectionName: 'logo_sliders';
  info: {
    singularName: 'logo-slider';
    pluralName: 'logo-sliders';
...
export interface ApiVideoCourseVideoCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media;
    VideoTopics: Attribute.Component<'video-topics.video-topics', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::logo-slider.logo-slider': ApiLogoSliderLogoSlider;
